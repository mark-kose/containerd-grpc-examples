...
/*
Package images is a reverse proxy.
...
var (
	filter_Images_List_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func RegisterImagesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ImagesClient) error {
	...
	mux.Handle("GET", pattern_Images_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Images_List_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Images_List_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Images_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "images", "list"}, "", runtime.AssumeColonVerbOpt(true)))
)
